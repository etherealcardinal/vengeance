...
namespace vitex
{
	namespace graphics
	{
		...
		public:
			...
			virtual trigonometry::vertex* get_elements(graphics_device* device) const = 0;
		...
		public:
			...
			virtual trigonometry::skin_vertex* get_elements(graphics_device* device) const = 0;
			element_buffer* get_vertex_buffer() const;
			element_buffer* get_index_buffer() const;
		};
		...
		public:
			...
			virtual expects_graphics<void> copy_texture_2d(texture_2d* resource, texture_2d** result) = 0;
			virtual expects_graphics<void> copy_texture_2d(graphics::render_target* resource, uint32_t target, texture_2d** result) = 0;
			virtual expects_graphics<void> copy_texture_2d(render_target_cube* resource, trigonometry::cube_face face, texture_2d** result) = 0;
			virtual expects_graphics<void> copy_texture_2d(multi_render_target_cube* resource, uint32_t cube, trigonometry::cube_face face, texture_2d** result) = 0;
			virtual expects_graphics<void> copy_texture_cube(render_target_cube* resource, texture_cube** result) = 0;
			virtual expects_graphics<void> copy_texture_cube(multi_render_target_cube* resource, uint32_t cube, texture_cube** result) = 0;
			...
			virtual expects_graphics<void> copy_back_buffer(texture_2d** result) = 0;
			...
			virtual expects_graphics<depth_stencil_state*> create_depth_stencil_state(const depth_stencil_state::desc& i) = 0;
			virtual expects_graphics<blend_state*> create_blend_state(const blend_state::desc& i) = 0;
			virtual expects_graphics<rasterizer_state*> create_rasterizer_state(const rasterizer_state::desc& i) = 0;
			virtual expects_graphics<sampler_state*> create_sampler_state(const sampler_state::desc& i) = 0;
			virtual expects_graphics<input_layout*> create_input_layout(const input_layout::desc& i) = 0;
			virtual expects_graphics<shader*> create_shader(const shader::desc& i) = 0;
			virtual expects_graphics<element_buffer*> create_element_buffer(const element_buffer::desc& i) = 0;
			virtual expects_graphics<mesh_buffer*> create_mesh_buffer(const mesh_buffer::desc& i) = 0;
			virtual expects_graphics<mesh_buffer*> create_mesh_buffer(element_buffer* vertex_buffer, element_buffer* index_buffer) = 0;
			virtual expects_graphics<skin_mesh_buffer*> create_skin_mesh_buffer(const skin_mesh_buffer::desc& i) = 0;
			virtual expects_graphics<skin_mesh_buffer*> create_skin_mesh_buffer(element_buffer* vertex_buffer, element_buffer* index_buffer) = 0;
			virtual expects_graphics<instance_buffer*> create_instance_buffer(const instance_buffer::desc& i) = 0;
			virtual expects_graphics<texture_2d*> create_texture_2d() = 0;
			virtual expects_graphics<texture_2d*> create_texture_2d(const texture_2d::desc& i) = 0;
			virtual expects_graphics<texture_3d*> create_texture_3d() = 0;
			virtual expects_graphics<texture_3d*> create_texture_3d(const texture_3d::desc& i) = 0;
			virtual expects_graphics<texture_cube*> create_texture_cube() = 0;
			virtual expects_graphics<texture_cube*> create_texture_cube(const texture_cube::desc& i) = 0;
			virtual expects_graphics<texture_cube*> create_texture_cube(texture_2d* resource[6]) = 0;
			virtual expects_graphics<texture_cube*> create_texture_cube(texture_2d* resource) = 0;
			virtual expects_graphics<depth_target_2d*> create_depth_target_2d(const depth_target_2d::desc& i) = 0;
			virtual expects_graphics<depth_target_cube*> create_depth_target_cube(const depth_target_cube::desc& i) = 0;
			virtual expects_graphics<render_target_2d*> create_render_target_2d(const render_target_2d::desc& i) = 0;
			virtual expects_graphics<multi_render_target_2d*> create_multi_render_target_2d(const multi_render_target_2d::desc& i) = 0;
			virtual expects_graphics<render_target_cube*> create_render_target_cube(const render_target_cube::desc& i) = 0;
			virtual expects_graphics<multi_render_target_cube*> create_multi_render_target_cube(const multi_render_target_cube::desc& i) = 0;
			virtual expects_graphics<cubemap*> create_cubemap(const cubemap::desc& i) = 0;
			virtual expects_graphics<query*> create_query(const query::desc& i) = 0;
